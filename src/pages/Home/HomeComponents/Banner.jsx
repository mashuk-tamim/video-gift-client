...
const Banner = () => {
	return (
		<section className="">
			<div className="w-full h-screen bg-[url('https://i.ibb.co/KGhqhvp/image-10.png')] bg-cover grayscale">
				<div className="w-full h-full flex flex-col  justify-center items-start bg-banner-gradient text-grayText px-20">
					...
					<p className="text-base pb-8">
						Transform your guests&apos; experience with
						personalized video that they will <br /> never forget
					</p>
					<div className="flex gap-5">
						...
						<button className=" text-black btn-ghost btn-outline rounded-md lg:py-2 px-6">
							<FaPlay className="inline-block text-lg"></FaPlay>{" "}
							Watch Video
						</button>
					</div>
				</div>
